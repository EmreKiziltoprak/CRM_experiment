...
function SubMenu({ width, height, borderRadius, backgroundColor, children, position, setActiveButtonIndex }: Props) {
  return (
    <OutsideAlerter onOutsideClick={()=>{setActiveButtonIndex(null)}}>
    <div
      style={{
        width: width,
        height: height,
