...
import { fetchProfileStart, fetchProfileSuccess, fetchProfileFailure } from '../slices/userSlice';
...
export const fetchUserProfile = (): ThunkAction<void, RootState, null, any> => async (dispatch) => {
