...
const theme = createTheme({
  components: {
    MuiButton: { // Target the MuiButton component
      styleOverrides: {
        root: { // Target the root element of the button
          boxShadow: 'none', // Remove shadow
        },
        contained: { // Target the contained variant for color change
          backgroundColor: '#yourDesiredColor', // Set your desired background color
          '&:hover': { // Target the active state
